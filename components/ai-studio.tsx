      ...
      <CardContent className="space-y-6">
        <div className="bg-white p-6 border rounded-lg space-y-6">
          ...
          <div className="pt-4 flex justify-between">
            <Button 
              variant="outline"
              onClick={() => handleFeedbackAction(selectedDimension.id, selectedFeedback.id, 'accepted')}
            ...
            <Button
              variant="outline"
              onClick={() => handleFeedbackAction(selectedDimension.id, selectedFeedback.id, 'rejected')}
